...
3. Read the warning and confirm the request.
...
- The phone number, profile, vacancies, applications, messages, sessions and
  other active data linked to the person are then deleted.
- Administrator audit records and the Coin financial ledger may be retained,
  but the name, phone number and other direct identifiers are removed.
- Data may remain in a backup until its 14-day retention period expires.
